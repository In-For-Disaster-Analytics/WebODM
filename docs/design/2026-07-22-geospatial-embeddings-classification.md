...
**Implementing** — passed a 5-reviewer spec-review pass (Decisions 26-31); implementation underway. See Decision 37 for this increment's real-vs-stub scope (real `embed-generate` Actor invocation; `model-train` invocation still deferred, no endpoint to call it from yet).
