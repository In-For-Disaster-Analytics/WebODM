...
urlpatterns = [
    ...
    url(r'^public/(?P<uuid_type>project|task)/(?P<uuid>[^/.]+)/map/$', public_views.map, name='public_map'),
    url(r'^public/(?P<uuid_type>project|task)/(?P<uuid>[^/.]+)/iframe/map/$', public_views.map_iframe, name='public_iframe_map'),
